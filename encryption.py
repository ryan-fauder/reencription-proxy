...
def decode_capsule_frag(capsule):
    return VerifiedCapsuleFrag.from_verified_bytes(base64.b64decode(capsule.encode()))
...
def encode_bytes(bytes_obj: bytes) -> str:
...
def grant_access(owner_secret_key, owner_signer, receiving_public_key, required_frags, total_frags):
